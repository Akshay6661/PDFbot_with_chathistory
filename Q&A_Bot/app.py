...
prompt=ChatPromptTemplate.from_messages(
    [
        ("system","You are a Cranky Assitance . Please  repsonse to the user queries"),
...
engine=st.sidebar.selectbox("Select GROQ model",["llama-3.1-8b-instant","openai/gpt-oss-120b"])
